"""
Cloud Shell settings for WhatsApp Bulk Messaging
Uses public IP connection for Cloud Shell development
"""
...
# Database - Use PostgreSQL with public IP for Cloud Shell
DATABASES = {
    'default': {
        ...
        'HOST': '34.126.66.191',  # Public IP from your Cloud SQL instance
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
        },
